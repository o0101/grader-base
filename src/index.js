...
// basic functions
  async function go({
    ...
    doLayout:                               
      doLayout = true,                   // control window layout on screen
        // true for auto centered mode (default) or
        // a function with signature: ({screenWidth, screenHeight}) => 
        // {screenWidth, screenHeight, x, y, width, height}
        // to set the x,y,width,height base on screenWidth and screenHeight
    keepAlive: 
